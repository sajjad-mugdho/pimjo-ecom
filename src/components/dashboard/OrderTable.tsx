...
const OrderTable = () => {
  ...
  if (loading) {
    return (
      <section className="w-[328px] md:max-w-[665px] md:w-[665px] h-[200px] bg-white dark:bg-[#101828] px-4 sm:px-6 py-4 rounded-2xl shadow-sm flex items-center justify-center">
  ...
  return (
    <section className="w-[328px] md:max-w-[665px] md:w-[665px] min-h-[463px] bg-white dark:bg-[#FFFFFF08] dark:border dark:border-[#1D2939] px-4 sm:px-6 py-4 rounded-2xl shadow-sm relative">
      <div className="flex flex-col md:flex-row md:items-center items-start min-h-[76px] justify-between border-b border-gray-200 dark:border-[#1D2939]">
        <h2 className="text-lg font-semibold dark:text-[#FFFFFFE5] p-4 md:p-6">
          Recent Orders
        </h2>
        <div className="flex items-center gap-3 md:gap-5 justify-center md:justify-end overflow-x-auto pb-2 md:pb-0">
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              className="inline-flex items-center h-11 gap-2 px-3 py-1 rounded-[8px] border border-[#D0D5DD] dark:border-[#1D2939] text-sm text-gray-700 dark:text-[#FFFFFFE5] hover:bg-gray-50 dark:hover:bg-[#1D2939]"
            >
              <svg
                width="20"
                height="20"
            ...
            {filterOpen && (
              <div className="absolute right-0 mt-2 z-[9999] p-3 bg-white dark:bg-[#101828] rounded-md shadow-lg border w-40">
          ...
          <button className="inline-flex items-center h-11 gap-2 px-3 py-1 rounded-[8px] border border-[#D0D5DD] dark:border-[#1D2939] text-sm text-gray-700 dark:text-[#FFFFFFE5] hover:bg-gray-50 dark:hover:bg-[#1D2939]">
            See all
          </button>
        </div>
      </div>
      ...
      <div className="overflow-x-auto">
        <table className="w-full min-w-[600px] md:min-w-[500px] table-auto">
          <thead className="my-2">
            <tr>
              <th className="min-w-[180px] md:min-w-[150px] text-left text-xs text-[#667085] dark:text-[#98A2B3] font-medium px-4 py-3 md:px-3 md:py-2">
                Product
              </th>
              <th className="min-w-[120px] md:min-w-[100px] text-left text-xs text-[#667085] dark:text-[#98A2B3] font-medium px-4 py-3 md:px-3 md:py-2">
                Category
              </th>
              <th className="min-w-[100px] md:min-w-[80px] text-left text-xs text-[#667085] dark:text-[#98A2B3] font-medium px-4 py-3 md:px-3 md:py-2">
                Price
              </th>
              <th className="min-w-[120px] md:min-w-[100px] text-left text-xs text-[#667085] dark:text-[#98A2B3] font-medium px-4 py-3 md:px-3 md:py-2">
                Status
          ...
          <tbody>
            {filtered.map((order) => (
              <tr
                key={order.id}
                className="border-t border-gray-100 dark:border-[#1D2939]"
              >
                <td className="font-medium flex items-center gap-3 px-4 py-4 md:px-3 md:py-2 min-w-[180px] md:min-w-[150px]">
                  ...
                  <div className="min-w-0">
                    <div className="truncate dark:text-[#FFFFFFE5]">
                      {order.product}
                    </div>
                    <p className="text-xs font-normal leading-6 text-gray-500 dark:text-[#98A2B3]">
                      2 Variants
                    </p>
                  </div>
                </td>
                <td className="text-sm text-[#667085] dark:text-[#98A2B3] px-4 py-4 md:px-3 md:py-2 min-w-[120px] md:min-w-[100px]">
                  {order.category}
                </td>
                <td className="text-sm text-[#667085] dark:text-[#98A2B3] px-4 py-4 md:px-3 md:py-2 min-w-[100px] md:min-w-[80px]">
                  {order.price}
                </td>
                <td className="px-4 py-4 md:px-3 md:py-2 min-w-[120px] md:min-w-[100px]">
                  {order.status === "Delivered" ? (
                    ...
                    <div className="w-[70px] h-[22px] flex items-center justify-center text-xs font-medium rounded-full bg-[#FFFAEB] dark:bg-[#F7900926] text-[#DC6803]">
                      Pending
                    </div>
                  ) : (
                    <div className="w-[70px] h-[22px] flex items-center justify-center text-xs font-medium rounded-full bg-[#FEF3F2] dark:bg-[#F0443826] text-[#DC2626]">
                      Cancelled
                    </div>
                  )}
                </td>
