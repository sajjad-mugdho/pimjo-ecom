...
//     return (
//       <div
//         className="w-[70px] h-[22px] flex items-center justify-center"
//         aria-hidden
//       >
//         <svg
//           width="70"
...
//     const byQuery = sampleProducts.filter((p) =>
//       p.product.toLowerCase().includes(query.toLowerCase())
//     );
//     return selectedStatuses.length > 0
//       ? byQuery.filter((p) => selectedStatuses.includes(p.status))
//       : byQuery;
...
//             <TableHeader>
//               <TableRow>
//                 <TableHead className="min-w-[180px] text-xs text-[#667085] font-medium">
//                   Product
//                 </TableHead>
...
//                   key={i}
//                   onClick={() => setPage(i + 1)}
//                   className={`w-8 h-8 inline-flex items-center justify-center rounded-md border ${
//                     page === i + 1 ? "bg-[#F2F4F7]" : "bg-white"
//                   }`}
//                 >
//                   {i + 1}
//                 </button>
